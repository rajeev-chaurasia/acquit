...
>
> The CLI is on PyPI (`pip install acquit==0.1.1`<!-- x-release-please-version -->), so the analysis itself pins cleanly.
>
> Both the CLI and the GitHub Action pin cleanly to v0.1.1. <!-- x-release-please-version -->
>
