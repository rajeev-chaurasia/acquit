...
>
> The CLI is on PyPI (`pip install acquit==0.2.0`<!-- x-release-please-version -->), so the analysis itself pins cleanly.
>
> Both the CLI and the GitHub Action pin cleanly to v0.2.0. <!-- x-release-please-version -->
>
...
jobs:
  tests:
    ...
    steps:
      ...
      - uses: rajeev-chaurasia/acquit@v0.2.0 # x-release-please-version
        with:
          mode: report
